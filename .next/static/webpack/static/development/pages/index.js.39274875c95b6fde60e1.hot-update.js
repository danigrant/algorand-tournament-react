...
/* harmony import */ var _components_CompetitionsGrid__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../components/CompetitionsGrid */ "./components/CompetitionsGrid.js");
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(Index, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.t0 = this;
                _context.next = 3;
                return Object(_utils_firebase__WEBPACK_IMPORTED_MODULE_13__["getCompetitions"])();
              ...
              case 3:
                ...
                console.log(this.state.competitions.length);
    ...
    value: function render() {
      return __jsx("div", {
        ...
        __self: this
      }, "To encourage mathematical research and raise the stakes, send some algos to the addresses of the escrow contracts.")), this.state.competitions.length > 0 && __jsx(_components_CompetitionsGrid__WEBPACK_IMPORTED_MODULE_11__["default"], {
        ...
        __self: this
      }), this.state.competitions.length == 0 && __jsx("p", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 39
        },
        __self: this
      }, "this.state: ", _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(this.state))));
    }
  }]);
...
//# sourceMappingURL=index.js.39274875c95b6fde60e1.hot-update.js.map